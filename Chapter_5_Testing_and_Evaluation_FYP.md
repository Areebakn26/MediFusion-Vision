...
2. [5.1 Unit Testing](#51-unit-testing)
3. [5.2 Functional Testing](#52-functional-testing)
4. [5.3 Business Rules Testing](#53-business-rules-testing)
5. [5.4 Integration Testing](#54-integration-testing)
6. [5.5 Test Summary](#55-test-summary)
7. [Appendix](#appendix)
...
**Table 5.1.1: Email Validation Test Cases**
...
The email validation function is implemented in `server/utils/validators.js` and tested using Jest framework. The function uses a regular expression pattern to validate email format.
...
**Table 5.1.2: Scan Validation Test Cases**
...
**Table 5.1.3: Password Hashing and Matching Test Cases**
...
### Functional Testing 1: Login with different roles (Admin, Patient, Doctor)

**Objective:** To ensure that the correct page with the correct navigation bar is loaded for each role.

**Table 5.2.1: Login Functionality Test Cases**
...
**Table 5.2.2: User Registration Test Cases**
...
**Table 5.2.3: Appointment Booking Test Cases**
...
**Table 5.2.4: Scan Upload and Analysis Test Cases**
...
**Table 5.3.1: Appointment Cancellation Refund Policy Decision Table**
...
**Table 5.3.2: Appointment Cancellation Refund Test Cases**
...
**Table 5.3.3: Account Lockout Policy Decision Table**
...
**Table 5.3.4: Account Lockout Test Cases**
...
**Table 5.3.5: Doctor Verification Status Decision Table**
...
**Table 5.3.6: Doctor Verification Test Cases**
...
**Table 5.3.7: Appointment Time Validation Decision Table**
...
**Table 5.3.8: Appointment Time Validation Test Cases**
...
**Table 5.4.1: Appointment Scheduling Integration Test Cases**
...
**Table 5.4.2: Scan Upload and AI Analysis Integration Test Cases**
...
**Table 5.4.3: User Registration and Profile Integration Test Cases**
...
**Table 5.4.4: Payment Processing Integration Test Cases**
...
**Table 5.5.1: Overall Test Results Summary**
...
### Appendix A: Test Implementation Code
