    ...
    const fetchDoctors = async () => {
        ...
        try {
            ...
            const formattedDoctors = data.map(doc => ({
                ...
                image: doc.profile_image || 'https://randomuser.me/api/portraits/women/68.jpg'
            }));
                    ...
                    {doctors.map((doctor) => (
                        <div key={doctor.id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden border border-gray-100">
                            <div className="p-6 flex flex-col items-center text-center">
                                <img src={doctor.image} alt={doctor.name} className="w-24 h-24 rounded-full object-cover mb-4 border-4 border-blue-50" />
